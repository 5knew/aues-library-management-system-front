...
function AddBook() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <input className="w-full p-2 border border-gray-300 rounded-md" type="text" name="category" value={book.category} onChange={handleChange} placeholder="Category" required />
